function FastClick(b) {
    ...
    this.onClick = function() {
        FastClick.prototype.onClick.apply(a, arguments)
    };
    this.onTouchStart = function() {
        FastClick.prototype.onTouchStart.apply(a, arguments)
    };
    this.onTouchMove = function() {
        FastClick.prototype.onTouchMove.apply(a, arguments)
    };
    this.onTouchEnd = function() {
        FastClick.prototype.onTouchEnd.apply(a, arguments)
    };
    this.onTouchCancel = function() {
        FastClick.prototype.onTouchCancel.apply(a, arguments)
    };
    ...
    if (!Event.prototype.stopImmediatePropagation) {
        b.removeEventListener = function(e, g, d) {
            var f = Node.prototype.removeEventListener;
            if (e === "click") {
                f.call(b, e, g.hijacked || g, d)
            } else {
                f.call(b, e, g, d)
            }
        };
        b.addEventListener = function(f, g, e) {
            var d = Node.prototype.addEventListener;
            if (f === "click") {
                d.call(b, f, g.hijacked || (g.hijacked = function(h) {
                    if (!h.propagationStopped) {
                        g(h)
                    }
                }), e)
            } else {
...
FastClick.prototype.sendClick = function(b, c) {
    ...
    a.initMouseEvent("click", true, true, window, 1, d.screenX, d.screenY, d.clientX, d.clientY, false, false, false, false, 0, null);
...
FastClick.prototype.onTouchStart = function(b) {
    var a, c;
    a = this.getTargetElementFromEventTarget(b.target);
    c = b.targetTouches[0];
    if (this.deviceIsIOS) {
...
FastClick.prototype.onTouchEnd = function(c) {
    ...
    if ((c.timeStamp - this.lastClickTime) < 200) {
    ...
    if (b === "label") {
        ...
        if (this.needsFocus(a)) {
            if ((c.timeStamp - d) > 100 || (this.deviceIsIOS && window.top !== window && b === "input")) {
                this.targetElement = null;
                return false
            }
            this.focus(a);
            if (!this.deviceIsIOS4 || b !== "select") {
                this.targetElement = null;
                c.preventDefault()
            }
            return false
...
FastClick.prototype.onClick = function(b) {
    var a;
    if (!this.targetElement) {
        return true
    }
    if (b.forwardedTouchEvent) {
        return true
    }
    ...
    if (!this.needsClick(a) || this.cancelNextClick) {
